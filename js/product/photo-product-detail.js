var swiperPhotoProduct = new Swiper('.swiper-photo', {
    // Optional parameters
...
var countdownTime = (timeCountdown) => {
    ...
    startTimer(timeCountdown, displayCountdown);
};

var startTimer = (duration, displayCountdown) => {
    var start = Date.now(),
        diff,
        hour,
        minutes,
    ...
    var timer = () => {
        ...
        displayCountdown.textContent = hour + ":" + minutes + ":" + seconds;
